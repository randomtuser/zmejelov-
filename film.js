...
preload(){
		super.preload()
		this.load.image("ozadje2","assets/film/scifi wallpaper.png")
	   //ploščadi
...
for (let x = -20; x < sirina+100; x = x + tileWidth ){
	const podenj =  platforms.create(x, 760, 'ploscad1')
	tiles.push(podenj)}
//ozadje full screen
...
//this.bg = this.add.image(1000 /2, visina/2, '#000000');
...
gameState.junak  = this.physics.add.sprite(300,300, "coolGuy")
gameState.junak.setScale()
