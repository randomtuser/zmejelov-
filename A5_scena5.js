...
create(){
	...
	this.physics.add.overlap(gameState.junak, izhod5, () => {
		if (usa == true){
			this.add.text(150, 350, 'Lol this is not an exit',{ fontSize: '40px', fill: '#000000',  fontFamily: 'CustomFont' });}
		else if (rus == true){
			this.add.text(150, 350, 'Лол это не выход',{ fontSize: '40px', fill: '#000000',  fontFamily: 'CustomFont' });}
		else{
			this.add.text(150, 350, 'lol, to ni izhod',{ fontSize: '40px', fill: '#000000',  fontFamily: 'CustomFont' });}
		})
