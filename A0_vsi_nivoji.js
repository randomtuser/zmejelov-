class A0_vsi_nivoji extends Phaser.Scene {
 ...
 create() {
    ...
    if (usa == true){
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 115, 'NEXT',{ fontSize: '40px',fill: '#B637BF',  fontFamily: 'CustomFont' });
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 190, 'HOME',{ fontSize: '40px',fill: '#B637BF',  fontFamily: 'CustomFont' });    }
    else if (rus == true){
        this.add.text(GAME_WIDTH-270,GAME_HEIGHT - 115, 'СЛЕДУЮЩИЙ',{ fontSize: '20px',fill: '#B637BF',  fontFamily: 'CustomFont' });
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 190, 'ДОМОЙ',{ fontSize: '40px',fill: '#B637BF',  fontFamily: 'CustomFont' });    }
    else{
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 115, 'NAPREJ',{ fontSize: '40px',fill: '#B637BF',  fontFamily: 'CustomFont' });
    ...
    this.l1 = this.add.image(x, y, 'L1')
        ...
        this.s1.setScale(.1)
        this.add.text(x-ime,y - imey , 'LEVEL 1',{ fontSize: '30px', fill: '#000000',  fontFamily: 'CustomFont' ,  fontFamily: 'CustomFont'});
    ...
    this.l2 = this.add.image(x+ zaKok * 1, y, 'L2')
        ...
        this.s1.setScale(.1)
        this.add.text(x+ zaKok * 1 -ime, y -imey , 'LEVEL 2',{ fontSize: '30px', fill: '#000000',  fontFamily: 'CustomFont' ,  fontFamily: 'CustomFont'});
        this.s1.on('pointerup', () => {
            vrniNaPogoj = true
            this.scene.stop('A0_vsi_nivoji')
    ...
    this.l3 = this.add.image(x+zaKok * 2, y, 'L3')
        ...
        this.s1.setScale(.1)
        this.add.text(x+ zaKok * 2 -ime, y -imey , 'LEVEL 3',{ fontSize: '30px', fill: '#000000',  fontFamily: 'CustomFont',  fontFamily: 'CustomFont' });
        this.s1.on('pointerup', () => {
            vrniNaPogoj = true
            this.scene.stop('A0_vsi_nivoji')
