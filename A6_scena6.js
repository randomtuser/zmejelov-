...
create(){
	...
	this.physics.add.overlap(gameState.junak, obvestilo2, () => {
		if (usa == true){
			this.add.text(800, visina - 6400,  'Uuuuuuu look a Terracotta army',{ fontSize: '40px',fill: '#A996BC',  fontFamily: 'CustomFont' });}
		else if (rus == true){
			this.add.text(800, visina - 6400, 'Ууууууу смотри терракотовую армию',{ fontSize: '40px',fill: '#A996BC',  fontFamily: 'CustomFont' });}
		else{
			this.add.text( 800, visina - 6400,   "Uuuuuuuuuu lej Glinena vojska", { fontFamily: 'CustomFont', fontSize: 36, color: '#ffffff' });}
	});
	}
